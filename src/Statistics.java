...
public class Statistics extends JFrame{
    ...
    public Statistics() {
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 51), 2, true), "Issue-Book-Details",
        ...
        mylabel.add(scrollPane_1);

        table_1 = new JTable();
        table_1.setBackground(new Color(204, 255, 255));
        table_1.setForeground(new Color(0,0,153));
        table_1.setFont(new Font("Sitka Small", Font.BOLD, 12));
        scrollPane_1.setViewportView(table_1);

        JPanel panel_1 = new JPanel();
        panel_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 51), 2, true), "Return-Book-Details",
                TitledBorder.RIGHT, TitledBorder.TOP, null, new Color(0, 0, 102)));
