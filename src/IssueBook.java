...
public class IssueBook extends JFrame implements ActionListener{
    ...
    public IssueBook() {
        ...
        t7.setForeground(new Color(0,0,153));
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 51), 2, true), "Issue-Book",
        ...
        t9 = new JTextField();
        t9.setForeground(new Color(0,0,153));
        ...
        t10 = new JTextField();
        t10.setForeground(new Color(0,0,153));
        ...
        t11 = new JTextField();
        t11.setForeground(new Color(0,0,153));
        ...
        t12 = new JTextField();
        t12.setForeground(new Color(0,0,153));
        ...
        t13 = new JTextField();
        t13.setForeground(new Color(0,0,153));
        ...
        t14 = new JTextField();
        t14.setForeground(new Color(0,0,153));
        ...
        panel_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 51), 2, true), "Student-Deatails",
                TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 102)));
